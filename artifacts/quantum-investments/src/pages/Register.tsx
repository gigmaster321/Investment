...
export default function Register() {
  ...
  const handleRegister = (e: React.FormEvent) => {
    e.preventDefault();
    // Simulate register and redirect to dashboard (or login)
    ...
    <div className="min-h-[100dvh] bg-background flex flex-col items-center justify-center relative overflow-hidden p-4 md:p-6 py-12">
      ...
      >
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <Button
            type="submit"
            className="w-full bg-gradient-to-r from-primary to-accent hover:from-primary hover:to-accent hover:shadow-[0_0_30px_rgba(30,167,255,0.4)] hover:scale-[1.02] transition-all duration-200 text-white font-semibold rounded-lg h-11 mt-6 border-0"
          >
            Create Account
          </Button>
        </form>
